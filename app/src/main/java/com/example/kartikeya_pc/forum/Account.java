...
public class Account extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String list1 = getIntent().getStringExtra("question");

        try {
            List<String> list = new ArrayList<String>(Arrays.asList(list1.split(",")));
            mAdapter = new StringListAdapter((ArrayList<String>) list);
        ...
        iv1 = (SelectableRoundedImageView) findViewById(R.id.image1);
    ...
    private void selectImage() {
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                boolean result = Utility.checkPermission(Account.this);
